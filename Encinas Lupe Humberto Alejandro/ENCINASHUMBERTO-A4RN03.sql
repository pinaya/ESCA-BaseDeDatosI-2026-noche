...
--
-- Servidor: localhost
-- Tiempo de generación: 03-03-2026 a las 00:28:04
...
CREATE TABLE IF NOT EXISTS `entrenador` (
  ...
  `nombre_entrenador` varchar(50) COLLATE utf8mb4_spanish_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `rutina` (
  ...
  `nombre_rutina` varchar(50) COLLATE utf8mb4_spanish_ci NOT NULL,
